...
export const api = {
  ...
  surge: (kind = 'bus', n, incident) => request('POST', '/api/surge', { kind, ...(n ? { n } : {}), ...(incident ? { incident } : {}) }),
...
export const DEMO_KEY = (typeof window !== 'undefined' && new URLSearchParams(window.location.search).get('key')) || 'demo'
